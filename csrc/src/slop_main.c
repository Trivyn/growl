        ...
        while (i < argc) {
            {
                ...
                if (string_eq(arg, SLOP_STR("--help")) || string_eq(arg, SLOP_STR("-h"))) {
                    ...
                    if ((i + 1) < argc) {
                        __auto_type _mv_326 = strlib_parse_int(main_argv_to_string(argv, (i + 1)));
                        if (_mv_326.is_ok) {
                            __auto_type val = _mv_326.data.ok;
                            max_tri = ((int64_t)(val));
    ...
    uint8_t** argv = (uint8_t**)_c_argv;
    {
        ...
        slop_arena* arena = &_arena;
        {
            ...
            if (args.show_version) {
                ...
                __auto_type _mv_327 = args.input_file;
                if (!_mv_327.has_value) {
                    ...
                    __auto_type input_path = _mv_327.value;
                    if (args.show_help) {
                        main_print_usage();
                        return 0;
                    } else {
                        {
                            ...
                            if (!_mv_328.is_ok) {
                                ...
                                switch (_mv_329.tag) {
                                    ...
                                    {
                                        __auto_type _ = _mv_329.data.file_error;
                                        printf("%s\n", "  (file error)");
                                        break;
                                    }
                                }
                                ...
                                __auto_type g = _mv_328.data.ok;
                                {
                                    ...
                                    }
                                    {
                                        ...
                                        __auto_type _mv_330 = args.background_file;
                                        if (_mv_330.has_value) {
                                            __auto_type bg_path = _mv_330.value;
                                            __auto_type _mv_331 = ttl_parse_ttl_file(arena, bg_path);
                                            if (!_mv_331.is_ok) {
                                                ...
                                                __auto_type bg_graph = _mv_331.data.ok;
                                                {
                                        ...
                                        }
                                        {
                                            ...
                                            }
                                            {
                                                ...
                                                __auto_type _mv_332 = growl_reason_with_config(arena, combined_ig, config);
                                                switch (_mv_332.tag) {
                                                    case types_ReasonerResult_reason_success:
                                                    {
                                                        __auto_type s = _mv_332.data.reason_success;
                                                        {
                                                            ...
                                                            if (validate_mode) {
                                                                ...
                                                                __auto_type _mv_333 = args.emit_file;
                                                                if (_mv_333.has_value) {
                                                                    __auto_type emit_path = _mv_333.value;
                                                                    {
                                                                        ...
                                                                        }
                                                                        {
                                                                            ...
                                                                            __auto_type _mv_334 = serialize_ttl_serialize_ttl_stream(arena, out_graph, config, emit_path);
                                                                            if (_mv_334.is_ok) {
                                                                                __auto_type _ = _mv_334.data.ok;
                                                                                if (!(quiet)) {
                                                    ...
                                                    {
                                                        __auto_type reports = _mv_332.data.reason_inconsistent;
                                                        {
                                                            __auto_type reason_elapsed = (slop_now_ms() - reason_start);
                                                            if (validate_mode) {
                                                                {
                                                                ...
                                                                __auto_type _mv_335 = ({ __auto_type _lst = reports; size_t _idx = (size_t)0; slop_option_types_InconsistencyReport _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                if (_mv_335.has_value) {
                                                                    __auto_type report = _mv_335.value;
                                                                    if (quiet) {
                                                                        printf("%.*s", (int)(input_path).len, (input_path).data);
                                                                        printf("%s", ": ");
                                                                        main_print_elapsed(arena, parse_elapsed);
                                                    ...
                                                    {
                                                        __auto_type s = _mv_332.data.reason_cancelled;

                                ...
                                __auto_type g = _mv_335.data.ok;
                                {
                                    ...
                                    }
                                    {
                                        ...
                                        }
                                        {
                                            ...
                                            __auto_type _mv_337 = growl_reason_with_config(arena, ig, config);
                                            switch (_mv_337.tag) {
                                                case types_ReasonerResult_reason_success:
                                                {
                                                    __auto_type s = _mv_337.data.reason_success;
                                                    {
                                                        ...
                                                        if (validate_mode) {
                                                            ...
                                                            __auto_type _mv_338 = args.emit_file;
                                                            if (_mv_338.has_value) {
                                                                __auto_type emit_path = _mv_338.value;
                                                                {
                                                                    ...
                                                                    }
                                                                    {
                                                                        ...
                                                                        __auto_type _mv_339 = serialize_ttl_serialize_ttl_stream(arena, out_graph, config, emit_path);
                                                                        if (_mv_339.is_ok) {
                                                                            __auto_type _ = _mv_339.data.ok;
                                                                            if (!(quiet)) {
                                                ...
                                                {
                                                    __auto_type report = _mv_337.data.reason_inconsistent;
                                                    {
                                                        __auto_type reason_elapsed = (slop_now_ms() - reason_start);
                                                        if (validate_mode) {

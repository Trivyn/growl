        ...
        while (i < argc) {
            {
                ...
                if (string_eq(arg, SLOP_STR("--help")) || string_eq(arg, SLOP_STR("-h"))) {
                    ...
                    if ((i + 1) < argc) {
                        __auto_type _mv_333 = strlib_parse_int(main_argv_to_string(argv, (i + 1)));
                        if (_mv_333.is_ok) {
                            __auto_type val = _mv_333.data.ok;
                            max_tri = ((int64_t)(val));
    ...
    uint8_t** argv = (uint8_t**)_c_argv;
    {
        ...
        slop_arena* arena = &_arena;
        {
            ...
            if (args.show_version) {
                ...
                __auto_type _mv_334 = args.input_file;
                if (!_mv_334.has_value) {
                    ...
                    __auto_type input_path = _mv_334.value;
                    if (args.show_help) {
                        main_print_usage();
                        return 0;
                    } else {
                        {
                            ...
                            if (!_mv_335.is_ok) {
                                ...
                                switch (_mv_336.tag) {
                                    ...
                                    {
                                        __auto_type _ = _mv_336.data.file_error;
                                        printf("%s\n", "  (file error)");
                                        break;
                                    }
                                }
                                ...
                                __auto_type g = _mv_335.data.ok;
                                {
                                    ...
                                    }
                                    {
                                        ...
                                        __auto_type _mv_337 = args.background_file;
                                        if (_mv_337.has_value) {
                                            __auto_type bg_path = _mv_337.value;
                                            __auto_type _mv_338 = ttl_parse_ttl_file(arena, bg_path);
                                            if (!_mv_338.is_ok) {
                                                ...
                                                __auto_type bg_graph = _mv_338.data.ok;
                                                {
                                        ...
                                        }
                                        {
                                            ...
                                            }
                                            {
                                                ...
                                                __auto_type _mv_339 = growl_reason_with_config(arena, combined_ig, config);
                                                switch (_mv_339.tag) {
                                                    case types_ReasonerResult_reason_success:
                                                    {
                                                        __auto_type s = _mv_339.data.reason_success;
                                                        {
                                                            ...
                                                            if (validate_mode) {
                                                                ...
                                                                __auto_type _mv_340 = args.emit_file;
                                                                if (_mv_340.has_value) {
                                                                    __auto_type emit_path = _mv_340.value;
                                                                    {
                                                                        ...
                                                                        }
                                                                        {
                                                                            ...
                                                                            __auto_type _mv_341 = serialize_ttl_serialize_ttl_stream(arena, out_graph, config, emit_path);
                                                                            if (_mv_341.is_ok) {
                                                                                __auto_type _ = _mv_341.data.ok;
                                                                                if (!(quiet)) {
                                                    ...
                                                    {
                                                        __auto_type reports = _mv_339.data.reason_inconsistent;
                                                        {
                                                            __auto_type reason_elapsed = (slop_now_ms() - reason_start);
                                                            if (validate_mode) {
                                                                {
                                                    ...
                                                    {
                                                        __auto_type s = _mv_339.data.reason_cancelled;

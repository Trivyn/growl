        ...
        while (!(rdf_term_eq(current, nil_term))) {
            {
                ...
                if ((((int64_t)((first_matches.triples).len)) > 0)) {
                    __auto_type _mv_94 = ({ __auto_type _lst = first_matches.triples; size_t _idx = (size_t)0; slop_option_rdf_Triple _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_94.has_value) {
            ...
            }
            {
                ...
                if ((((int64_t)((rest_matches.triples).len)) > 0)) {
                    __auto_type _mv_95 = ({ __auto_type _lst = rest_matches.triples; size_t _idx = (size_t)0; slop_option_rdf_Triple _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_95.has_value) {
        ...
        while (!(rdf_term_eq(current, nil_term))) {
            {
                ...
                if ((((int64_t)((first_matches).len)) > 0)) {
                    __auto_type _mv_96 = ({ __auto_type _lst = first_matches; size_t _idx = (size_t)0; slop_option_rdf_Triple _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_96.has_value) {
            ...
            }
            {
                ...
                if ((((int64_t)((rest_matches).len)) > 0)) {
                    __auto_type _mv_97 = ({ __auto_type _lst = rest_matches; size_t _idx = (size_t)0; slop_option_rdf_Triple _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_97.has_value) {

...
slop_result_types_Delta_types_InconsistencyReport engine_apply_all_rules_sequential(slop_arena* arena, index_IndexedGraph g, types_Delta delta, types_ReasonerConfig config) {
    ...
    slop_result_types_Delta_types_InconsistencyReport _retval;
    {
        ...
        {
            __auto_type t0 = slop_now_ms();
            __auto_type _mv_153 = cax_apply_cax_rules(arena, g, delta, fast);
            if (_mv_153.is_ok) {
        ...
        {
            __auto_type t0 = slop_now_ms();
            __auto_type _mv_154 = prp_apply_prp_rules(arena, g, delta, fast);
            if (_mv_154.is_ok) {
        ...
        {
            __auto_type t0 = slop_now_ms();
            __auto_type _mv_155 = eq_apply_eq_rules(arena, g, delta, fast);
            if (_mv_155.is_ok) {
        ...
        {
            __auto_type t0 = slop_now_ms();
            __auto_type _mv_156 = cls_apply_cls_rules(arena, g, delta, fast);
            if (_mv_156.is_ok) {
...
slop_result_types_Delta_types_InconsistencyReport engine_apply_all_rules_parallel(slop_arena* arena, index_IndexedGraph g, types_Delta delta, types_ReasonerConfig config) {
    ...
    slop_result_types_Delta_types_InconsistencyReport _retval;
    {
        ...
        {
            __auto_type workers = engine_spawn_rule_workers(arena, g, delta, result_chan, arena_scm_class, arena_scm_prop, arena_scm_domrng, arena_cax_infer, arena_cax_check, arena_prp_char, arena_prp_chain, arena_prp_check, arena_eq_infer, arena_eq_check, arena_cls_set, arena_cls_ind, config.verbose, fast);
            {

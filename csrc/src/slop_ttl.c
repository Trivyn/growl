...
slop_result_ttl_TermResult_common_ParseError ttl_parse_iri_ref(slop_arena* arena, ttl_TtlParseContext ctx) {
    SLOP_PRE(((common_state_peek(ctx.state) == 60)), "(== (state-peek ctx.state) 60)");
    {
        __auto_type s1 = common_state_advance(arena, ctx.state);
        {
            ...
            __auto_type _mv_279 = r;
            if (_mv_279.is_ok) {
                __auto_type res = _mv_279.data.ok;
...
slop_result_ttl_TermResult_common_ParseError ttl_parse_prefixed_name(slop_arena* arena, ttl_TtlParseContext ctx) {
    {
        __auto_type prefix_result = common_parse_while(arena, ctx.state, (slop_closure_t){(void*)_wrap_ttl_is_pn_chars, NULL});
        {
            ...
            __auto_type _mv_280 = s1;
            if (_mv_280.is_ok) {
                __auto_type s2 = _mv_280.data.ok;
                {
                    __auto_type local_result = ttl_parse_pn_local(arena, s2);
                    {
                        ...
                        __auto_type _mv_281 = lookup;
                        if (_mv_281.has_value) {
                            __auto_type base_iri = _mv_281.value;
        ...
        if ((c == 91)) {
                    ...
                    } else {
                        {
                            __auto_type gen = ttl_context_gen_blank_id(arena, ctx);
                            {
                                __auto_type bnode = rdf_make_blank(arena, gen.id);
                                {
                                    ...
                                    __auto_type _mv_282 = pol_result;
                                    if (_mv_282.is_ok) {
                                        __auto_type polr = _mv_282.data.ok;
                                        {
                                            __auto_type s3 = common_skip_whitespace(arena, polr.ctx.state);
                                            {
                                                __auto_type s4 = common_expect_char(arena, s3, 93);
                                                __auto_type _mv_283 = s4;
                                                if (_mv_283.is_ok) {
                                                    __auto_type s5 = _mv_283.data.ok;
        ...
        } else {
            {
                __auto_type s1 = common_state_advance(arena, ctx.state);
                {
                    ...
                    __auto_type _mv_284 = s2;
                    if (_mv_284.is_ok) {
                        __auto_type s3 = _mv_284.data.ok;
                        {
                            __auto_type label_result = common_parse_while(arena, s3, (slop_closure_t){(void*)_wrap_ttl_is_pn_chars, NULL});
                            {
                                ...
                                __auto_type _mv_285 = existing;
                                if (_mv_285.has_value) {
                                    __auto_type existing_id = _mv_285.value;
...
slop_result_ttl_TermResult_common_ParseError ttl_parse_blank_node(slop_arena* arena, ttl_TtlParseContext ctx) {
    {
        ...
        __auto_type _mv_286 = r;
        if (_mv_286.is_ok) {
            __auto_type ttr = _mv_286.data.ok;
                        ...
                        if ((c == 92)) {
                            {
                                ...
                                __auto_type _mv_287 = esc;
                                if (_mv_287.is_ok) {
                                    __auto_type er = _mv_287.data.ok;
...
slop_result_ttl_TermResult_common_ParseError ttl_parse_literal(slop_arena* arena, ttl_TtlParseContext ctx) {
    {
        ...
        __auto_type _mv_289 = str_result;
        if (_mv_289.is_ok) {
            __auto_type sr = _mv_289.data.ok;
            {
                            ...
                            if ((common_state_peek(s2) == 60)) {
                                {
                                    ...
                                    __auto_type _mv_290 = iri_result;
                                    if (_mv_290.is_ok) {
                                        __auto_type ir = _mv_290.data.ok;
                                        __auto_type _mv_291 = ir.term;
                                        switch (_mv_291.tag) {
                                            case rdf_Term_term_iri:
                                            {
                                                __auto_type iri_val = _mv_291.data.term_iri;
                            ...
                            } else {
                                {
                                    ...
                                    __auto_type _mv_292 = pn_result;
                                    if (_mv_292.is_ok) {
                                        __auto_type pr = _mv_292.data.ok;
                                        __auto_type _mv_293 = pr.term;
                                        switch (_mv_293.tag) {
                                            case rdf_Term_term_iri:
                                            {
                                                __auto_type iri_val = _mv_293.data.term_iri;
...
slop_result_ttl_TermTriplesResult_common_ParseError ttl_parse_collection(slop_arena* arena, ttl_TtlParseContext ctx) {
    {
        ...
        while ((!(common_state_at_end(cur_ctx.state)) && (common_state_peek(cur_ctx.state) != 41))) {
            {
                ...
                __auto_type _mv_294 = elem_result;
                if (_mv_294.is_ok) {
                    __auto_type er = _mv_294.data.ok;
                    {
                    ...
                    }
                    {
                        __auto_type gen = ttl_context_gen_blank_id(arena, er.ctx);
                        {
                            ...
                            __auto_type _mv_295 = prev_node;
                            if (_mv_295.has_value) {
                                __auto_type pn = _mv_295.value;
                            ...
                            __auto_type _mv_296 = first_node;
        ...
        __auto_type _mv_297 = prev_node;
        if (_mv_297.has_value) {
            __auto_type pn = _mv_297.value;
        ...
        }
        {
            ...
            __auto_type _mv_298 = s_end;
            if (_mv_298.is_ok) {
                __auto_type s_after = _mv_298.data.ok;
...
slop_result_ttl_TermTriplesResult_common_ParseError ttl_parse_term_extended(slop_arena* arena, ttl_TtlParseContext ctx) {
    {
        ...
        if ((c == 91)) {
        ...
        } else {
            {
                ...
                __auto_type _mv_299 = r;
                if (_mv_299.is_ok) {
                    __auto_type tr = _mv_299.data.ok;
                ...
                if (strlib_starts_with(keyword, SLOP_STR("prefix"))) {
                    {
                        __auto_type prefix_name = common_parse_while(arena, s2, (slop_closure_t){(void*)_wrap_ttl_is_pn_chars, NULL});
                        {
                            ...
                            __auto_type _mv_300 = s3;
                            if (_mv_300.is_ok) {
                                __auto_type s4 = _mv_300.data.ok;
                                {
                                        ...
                                        if (_mv_301.is_ok) {
                                            __auto_type ir = _mv_301.data.ok;
                                            {
                                                __auto_type s6 = common_skip_whitespace(arena, ir.ctx.state);
                                                {
                                                    ...
                                                    __auto_type _mv_302 = s7;
                                                    if (_mv_302.is_ok) {
                                                        __auto_type s8 = _mv_302.data.ok;
                ...
                } else {
                    {
                        ...
                        __auto_type _mv_303 = iri_result;
                        if (_mv_303.is_ok) {
                            __auto_type ir = _mv_303.data.ok;
                            {
                                __auto_type s3 = common_skip_whitespace(arena, ir.ctx.state);
                                {
                                    __auto_type s4 = common_expect_char(arena, s3, 46);
                                    __auto_type _mv_304 = s4;
                                    if (_mv_304.is_ok) {
                                        __auto_type s5 = _mv_304.data.ok;
        ...
        __auto_type kw = common_parse_while(arena, ctx.state, (slop_closure_t){(void*)_wrap_ttl_is_pn_chars_base, NULL});
        {
            __auto_type s1 = common_skip_whitespace(arena, kw.state);
            {
                __auto_type prefix_name = common_parse_while(arena, s1, (slop_closure_t){(void*)_wrap_ttl_is_pn_chars, NULL});
                {
                    ...
                    __auto_type _mv_305 = s2;
                    if (_mv_305.is_ok) {
                        __auto_type s3 = _mv_305.data.ok;
                        {
                            __auto_type s4 = common_skip_whitespace(arena, s3);
                            {
                                ...
                                __auto_type _mv_306 = iri_result;
                                if (_mv_306.is_ok) {
                                    __auto_type ir = _mv_306.data.ok;
...
slop_result_ttl_TripleResult_common_ParseError ttl_parse_triple(slop_arena* arena, ttl_TtlParseContext ctx) {
    {
        ...
        __auto_type _mv_307 = sub_result;
        if (_mv_307.is_ok) {
            __auto_type sr = _mv_307.data.ok;
            {
                __auto_type s1 = common_skip_whitespace(arena, sr.ctx.state);
                {
                    ...
                    __auto_type _mv_308 = pred_result;
                    if (_mv_308.is_ok) {
                        __auto_type pr = _mv_308.data.ok;
                        {
                            __auto_type s2 = common_skip_whitespace(arena, pr.ctx.state);
                            {
                                ...
                                __auto_type _mv_309 = obj_result;
                                if (_mv_309.is_ok) {
                                    __auto_type objr = _mv_309.data.ok;
                                    {
                                        __auto_type s3 = common_skip_whitespace(arena, objr.ctx.state);
                                        {
                                            __auto_type s4 = common_expect_char(arena, s3, 46);
                                            __auto_type _mv_310 = s4;
                                            if (_mv_310.is_ok) {
                                                __auto_type s5 = _mv_310.data.ok;
                ...
                __auto_type s1 = common_skip_whitespace(arena, cur_ctx.state);
                {
                    ...
                    if (((c1 == 46) || ((c1 == 93) || (c1 == 0)))) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_311 = pred_result;
                            if (_mv_311.is_ok) {
                                __auto_type pr = _mv_311.data.ok;
                                {
                                    __auto_type obj_list_result = ttl_parse_object_list(arena, pr.ctx, subject, pr.term);
                                    __auto_type _mv_312 = obj_list_result;
                                    if (_mv_312.is_ok) {
                                        __auto_type olr = _mv_312.data.ok;
                                        {
        ...
        while (!(done)) {
            {
                __auto_type s1 = common_skip_whitespace(arena, cur_ctx.state);
                {
                    ...
                    __auto_type _mv_313 = obj_result;
                    if (_mv_313.is_ok) {
                        __auto_type objr = _mv_313.data.ok;
                        {
                    ...
                    if ((c == 64)) {
                        {
                            ...
                            __auto_type _mv_314 = dir_result;
                            if (_mv_314.is_ok) {
                                __auto_type new_ctx = _mv_314.data.ok;
                                ctx = new_ctx;
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_316 = sub_result;
                            if (_mv_316.is_ok) {
                                __auto_type sr = _mv_316.data.ok;
                                {
                                ...
                                }
                                {
                                    ...
                                    __auto_type _mv_317 = pol_result;
                                    if (_mv_317.is_ok) {
                                        __auto_type polr = _mv_317.data.ok;
                                        {
                                        ...
                                        }
                                        {
                                            ...
                                            {
                                                __auto_type s4 = common_expect_char(arena, s3, 46);
                                                __auto_type _mv_318 = s4;
                                                if (_mv_318.is_ok) {
                                                    __auto_type s5 = _mv_318.data.ok;
...
slop_result_rdf_Graph_ttl_TtlFileError ttl_parse_ttl_file(slop_arena* arena, slop_string path) {
    SLOP_PRE(((string_len(path) > 0)), "(> (string-len path) 0)");
    {
        ...
        __auto_type _mv_319 = f;
        if (_mv_319.is_ok) {
            __auto_type handle = _mv_319.data.ok;
            {
                __auto_type content = file_file_read_all(arena, (&handle));
                __auto_type _mv_320 = content;
                if (_mv_320.is_ok) {
                    __auto_type text = _mv_320.data.ok;
                    file_file_close((&handle));
                    __auto_type _mv_321 = ttl_parse_ttl_string(arena, text);
                    if (_mv_321.is_ok) {
                        __auto_type g = _mv_321.data.ok;

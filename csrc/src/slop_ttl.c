...
slop_result_ttl_TermResult_common_ParseError ttl_parse_iri_ref(slop_arena* arena, ttl_TtlParseContext ctx) {
    SLOP_PRE(((common_state_peek(ctx.state) == 60)), "(== (state-peek ctx.state) 60)");
    {
        __auto_type s1 = common_state_advance(arena, ctx.state);
        {
            ...
            __auto_type _mv_257 = r;
            if (_mv_257.is_ok) {
                __auto_type res = _mv_257.data.ok;
...
slop_result_ttl_TermResult_common_ParseError ttl_parse_prefixed_name(slop_arena* arena, ttl_TtlParseContext ctx) {
    {
        __auto_type prefix_result = common_parse_while(arena, ctx.state, (slop_closure_t){(void*)_wrap_ttl_is_pn_chars, NULL});
        {
            ...
            __auto_type _mv_258 = s1;
            if (_mv_258.is_ok) {
                __auto_type s2 = _mv_258.data.ok;
                {
                    __auto_type local_result = ttl_parse_pn_local(arena, s2);
                    {
                        ...
                        __auto_type _mv_259 = lookup;
                        if (_mv_259.has_value) {
                            __auto_type base_iri = _mv_259.value;
        ...
        if ((c == 91)) {
                    ...
                    } else {
                        {
                            __auto_type gen = ttl_context_gen_blank_id(arena, ctx);
                            {
                                __auto_type bnode = rdf_make_blank(arena, gen.id);
                                {
                                    ...
                                    __auto_type _mv_260 = pol_result;
                                    if (_mv_260.is_ok) {
                                        __auto_type polr = _mv_260.data.ok;
                                        {
                                            __auto_type s3 = common_skip_whitespace(arena, polr.ctx.state);
                                            {
                                                __auto_type s4 = common_expect_char(arena, s3, 93);
                                                __auto_type _mv_261 = s4;
                                                if (_mv_261.is_ok) {
                                                    __auto_type s5 = _mv_261.data.ok;
        ...
        } else {
            {
                __auto_type s1 = common_state_advance(arena, ctx.state);
                {
                    ...
                    __auto_type _mv_262 = s2;
                    if (_mv_262.is_ok) {
                        __auto_type s3 = _mv_262.data.ok;
                        {
                            __auto_type gen = ttl_context_gen_blank_id(arena, ctx);
                            {
                        ...
                        __auto_type e = _mv_262.data.err;
                        return ((slop_result_ttl_TermTriplesResult_common_ParseError){ .is_ok = false, .data.err = e });
                    }
                }
            }
...
slop_result_ttl_TermResult_common_ParseError ttl_parse_blank_node(slop_arena* arena, ttl_TtlParseContext ctx) {
    {
        ...
        __auto_type _mv_263 = r;
        if (_mv_263.is_ok) {
            __auto_type ttr = _mv_263.data.ok;
            ...
            __auto_type e = _mv_263.data.err;
            return ((slop_result_ttl_TermResult_common_ParseError){ .is_ok = false, .data.err = e });
        }
    }
}
                        ...
                        if ((c == 92)) {
                            {
                                ...
                                __auto_type _mv_264 = esc;
                                if (_mv_264.is_ok) {
                                    __auto_type er = _mv_264.data.ok;
                                    result = slop_string_push_char(arena, result, er.slop_char);
                                    s = er.ctx.state;
                                } else if (!_mv_264.is_ok) {
                                    __auto_type e = _mv_264.data.err;
                ...
                while ((!(done) && !(common_state_at_end(s)))) {
                    {
                        ...
                        if ((c == 92)) {
                            {
                                __auto_type esc = ttl_parse_escape_sequence(arena, ((ttl_TtlParseContext){.prefixes = ctx.prefixes, .base_iri = ctx.base_iri, .blank_counter = ctx.blank_counter, .state = s}));
                                __auto_type _mv_265 = esc;
                                if (_mv_265.is_ok) {
                                    __auto_type er = _mv_265.data.ok;
                                    result = slop_string_push_char(arena, result, er.slop_char);
                                    s = er.ctx.state;
                                } else if (!_mv_265.is_ok) {
                                    __auto_type e = _mv_265.data.err;
                                    return ((slop_result_ttl_StringResult_common_ParseError){ .is_ok = false, .data.err = e });
                                    /* empty list */;
                                }
                            }
...
slop_result_ttl_TermResult_common_ParseError ttl_parse_literal(slop_arena* arena, ttl_TtlParseContext ctx) {
    {
        ...
        __auto_type _mv_266 = str_result;
        if (_mv_266.is_ok) {
            __auto_type sr = _mv_266.data.ok;
            {
                            ...
                            if ((common_state_peek(s2) == 60)) {
                                {
                                    ...
                                    __auto_type _mv_267 = iri_result;
                                    if (_mv_267.is_ok) {
                                        __auto_type ir = _mv_267.data.ok;
                                        __auto_type _mv_268 = ir.term;
                                        switch (_mv_268.tag) {
                                            case rdf_Term_term_iri:
                                            {
                                                __auto_type iri_val = _mv_268.data.term_iri;
                                        ...
                                        __auto_type e = _mv_267.data.err;
                                        return ((slop_result_ttl_TermResult_common_ParseError){ .is_ok = false, .data.err = e });
                                    }
                                }
                            } else {
                                {
                                    ...
                                    __auto_type _mv_269 = pn_result;
                                    if (_mv_269.is_ok) {
                                        __auto_type pr = _mv_269.data.ok;
                                        __auto_type _mv_270 = pr.term;
                                        switch (_mv_270.tag) {
                                            case rdf_Term_term_iri:
                                            {
                                                __auto_type iri_val = _mv_270.data.term_iri;
            ...
            __auto_type e = _mv_266.data.err;
            return ((slop_result_ttl_TermResult_common_ParseError){ .is_ok = false, .data.err = e });
        }
    }
}
...
slop_result_ttl_TermTriplesResult_common_ParseError ttl_parse_collection(slop_arena* arena, ttl_TtlParseContext ctx) {
    {
        ...
        while ((!(common_state_at_end(cur_ctx.state)) && (common_state_peek(cur_ctx.state) != 41))) {
            {
                ...
                __auto_type _mv_271 = elem_result;
                if (_mv_271.is_ok) {
                    __auto_type er = _mv_271.data.ok;
                    {
                    ...
                    }
                    {
                        __auto_type gen = ttl_context_gen_blank_id(arena, er.ctx);
                        {
                            ...
                            __auto_type _mv_272 = prev_node;
                            if (_mv_272.has_value) {
                                __auto_type pn = _mv_272.value;
                            ...
                            __auto_type _mv_273 = first_node;
                            if (_mv_273.has_value) {
                                __auto_type _ = _mv_273.value;
                                /* empty list */;
                    ...
                    __auto_type e = _mv_271.data.err;
                    return ((slop_result_ttl_TermTriplesResult_common_ParseError){ .is_ok = false, .data.err = e });
                    /* empty list */;
                }
            }
        }
        __auto_type _mv_274 = prev_node;
        if (_mv_274.has_value) {
            __auto_type pn = _mv_274.value;
        ...
        }
        {
            ...
            __auto_type _mv_275 = s_end;
            if (_mv_275.is_ok) {
                __auto_type s_after = _mv_275.data.ok;
                ...
                __auto_type e = _mv_275.data.err;
                return ((slop_result_ttl_TermTriplesResult_common_ParseError){ .is_ok = false, .data.err = e });
            }
        }
    }
...
slop_result_ttl_TermTriplesResult_common_ParseError ttl_parse_term_extended(slop_arena* arena, ttl_TtlParseContext ctx) {
    {
        ...
        if ((c == 91)) {
        ...
        } else {
            {
                ...
                if (_mv_276.is_ok) {
                    __auto_type tr = _mv_276.data.ok;
                ...
                if (strlib_starts_with(keyword, SLOP_STR("prefix"))) {
                    {
                        __auto_type prefix_name = common_parse_while(arena, s2, (slop_closure_t){(void*)_wrap_ttl_is_pn_chars, NULL});
                        {
                            ...
                            __auto_type _mv_277 = s3;
                            if (_mv_277.is_ok) {
                                __auto_type s4 = _mv_277.data.ok;
                                {
                                    __auto_type s5 = common_skip_whitespace(arena, s4);
                                    {
                                        ...
                                        __auto_type _mv_278 = iri_result;
                                        if (_mv_278.is_ok) {
                                            __auto_type ir = _mv_278.data.ok;
                                            {
                                                __auto_type s6 = common_skip_whitespace(arena, ir.ctx.state);
                                                {
                                                    __auto_type s7 = common_expect_char(arena, s6, 46);
                                                    __auto_type _mv_279 = s7;
                                                    if (_mv_279.is_ok) {
                                                        __auto_type s8 = _mv_279.data.ok;
                        ...
                        if (_mv_280.is_ok) {
                            __auto_type ir = _mv_280.data.ok;
                            {
                                __auto_type s3 = common_skip_whitespace(arena, ir.ctx.state);
                                {
                                    ...
                                    __auto_type _mv_281 = s4;
                                    if (_mv_281.is_ok) {
                                        __auto_type s5 = _mv_281.data.ok;
                                        ...
                                        __auto_type e = _mv_281.data.err;
                                        return ((slop_result_ttl_TtlParseContext_common_ParseError){ .is_ok = false, .data.err = e });
                                    }
                                }
                            }
        ...
        __auto_type kw = common_parse_while(arena, ctx.state, (slop_closure_t){(void*)_wrap_ttl_is_pn_chars_base, NULL});
        {
            __auto_type s1 = common_skip_whitespace(arena, kw.state);
            {
                __auto_type prefix_name = common_parse_while(arena, s1, (slop_closure_t){(void*)_wrap_ttl_is_pn_chars, NULL});
                {
                    ...
                    __auto_type _mv_282 = s2;
                    if (_mv_282.is_ok) {
                        __auto_type s3 = _mv_282.data.ok;
                        {
...
slop_result_ttl_TripleResult_common_ParseError ttl_parse_triple(slop_arena* arena, ttl_TtlParseContext ctx) {
    {
        ...
        __auto_type _mv_284 = sub_result;
        if (_mv_284.is_ok) {
            __auto_type sr = _mv_284.data.ok;
            {
                __auto_type s1 = common_skip_whitespace(arena, sr.ctx.state);
                {
                    ...
                    __auto_type _mv_285 = pred_result;
                    if (_mv_285.is_ok) {
                        __auto_type pr = _mv_285.data.ok;
                        {
                            __auto_type s2 = common_skip_whitespace(arena, pr.ctx.state);
                            {
                                ...
                                __auto_type _mv_286 = obj_result;
                                if (_mv_286.is_ok) {
                                    __auto_type objr = _mv_286.data.ok;
                                    {
                                        __auto_type s3 = common_skip_whitespace(arena, objr.ctx.state);
                                        {
                                            __auto_type s4 = common_expect_char(arena, s3, 46);
                                            __auto_type _mv_287 = s4;
                                            if (_mv_287.is_ok) {
                                                __auto_type s5 = _mv_287.data.ok;
                ...
                __auto_type s1 = common_skip_whitespace(arena, cur_ctx.state);
                {
                    ...
                    if (((c1 == 46) || ((c1 == 93) || (c1 == 0)))) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_288 = pred_result;
                            if (_mv_288.is_ok) {
                                __auto_type pr = _mv_288.data.ok;
                                {
                                    __auto_type obj_list_result = ttl_parse_object_list(arena, pr.ctx, subject, pr.term);
                                    __auto_type _mv_289 = obj_list_result;
                                    if (_mv_289.is_ok) {
                                        __auto_type olr = _mv_289.data.ok;
                                        {
        ...
        while (!(done)) {
            {
                __auto_type s1 = common_skip_whitespace(arena, cur_ctx.state);
                {
                    ...
                    __auto_type _mv_290 = obj_result;
                    if (_mv_290.is_ok) {
                        __auto_type objr = _mv_290.data.ok;
                        {
                    ...
                    if ((c == 64)) {
                        {
                            ...
                            __auto_type _mv_291 = dir_result;
                            if (_mv_291.is_ok) {
                                __auto_type new_ctx = _mv_291.data.ok;
                                ctx = new_ctx;
                    ...
                    } else if (((c == 80) || (c == 66))) {
                        {
                            ...
                            __auto_type _mv_292 = dir_result;
                            if (_mv_292.is_ok) {
                                __auto_type new_ctx = _mv_292.data.ok;
                                ctx = new_ctx;
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_293 = sub_result;
                            if (_mv_293.is_ok) {
                                __auto_type sr = _mv_293.data.ok;
                                {
                                ...
                                }
                                {
                                    ...
                                    __auto_type _mv_294 = pol_result;
                                    if (_mv_294.is_ok) {
                                        __auto_type polr = _mv_294.data.ok;
                                        {
                                        ...
                                        }
                                        {
                                            ...
                                            {
                                                __auto_type s4 = common_expect_char(arena, s3, 46);
                                                __auto_type _mv_295 = s4;
                                                if (_mv_295.is_ok) {
                                                    __auto_type s5 = _mv_295.data.ok;
...
slop_result_rdf_Graph_ttl_TtlFileError ttl_parse_ttl_file(slop_arena* arena, slop_string path) {
    SLOP_PRE(((string_len(path) > 0)), "(> (string-len path) 0)");
    {
        ...
        __auto_type _mv_296 = f;
        if (_mv_296.is_ok) {
            __auto_type handle = _mv_296.data.ok;
            {
                __auto_type content = file_file_read_all(arena, (&handle));
                __auto_type _mv_297 = content;
                if (_mv_297.is_ok) {
                    __auto_type text = _mv_297.data.ok;
                    file_file_close((&handle));
                    __auto_type _mv_298 = ttl_parse_ttl_string(arena, text);
                    if (_mv_298.is_ok) {
                        __auto_type g = _mv_298.data.ok;
